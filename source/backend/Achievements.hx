...
class Achievements {
	public static function init()
	{
		...
		#end
		createAchievement('cachumba',               {name: "Cachumba cachumba!", description: "You are the good-good one (yes, I'm calling you of a box of chocolate, that in the Brazil we call it Bombom)! You just unlocked the 'Penis Mode'.", hidden: true});
